...
const required = ['src/agents.mjs','src/agentteams-adapter.mjs','src/contracts.mjs','src/isolated-mc-server.mjs','src/knowledge.mjs','src/metrics.mjs','src/mission-control-client.mjs','src/rollback.mjs','src/runtime.mjs','src/skills.mjs','src/tool-registry.mjs','src/trace.mjs','adapters/mission-control/client.mjs','scripts/agentteams-integration.mjs','scripts/demo.mjs','scripts/evaluate.mjs','scripts/integration.mjs','docs/disclosure.md','deploy/agentteams/team.yaml','deploy/isolated-demo.env'];
